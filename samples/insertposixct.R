...
# This sample program demonstrates how to insert R POSIXct values into a temporary table using the DBI::dbWriteTable method.
...
main <- function () {
	...
	tryCatch ({
		...
		df <- data.frame (c1 = as.POSIXct (c (
			'1999-01-02 01:02:03',
			'2000-03-04 11:22:33.123',
			"2001-10-11 12:34:56.123456",
			NA
		)))
